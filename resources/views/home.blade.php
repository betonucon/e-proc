                                        ...
                                        <div class="row">   
                                            <div class="col-md-6">   
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" readonly value="{{$data->npwp}}" class="form-control form-control-sm" placeholder="ketik disini...">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label text-right">Nama  Perusahaan</label>
                                                    <div class="col-lg-8">
                                                        <input type="text" readonly value="{{$data->perusahaan}}" class="form-control form-control-sm" placeholder="ketik disini...">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                    ...
                                    <form class="form-horizontal  form-bordered" id="mydatakirim" method="post" action="{{ url('vendors/store_kirim') }}" enctype="multipart/form-data" >
                                        ...
                                        <div class="col-md-12">   
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10 text-center">
                                                    <span id="cekkirim" class="btn btn-sm btn-success" ><i class="fa fa-share-square"></i> Kirim Pengajuan</span>
                                                </div>
                                                <div class="col-lg-1">
        ...
        $("#cekkirim").click(function(e) {
            swal({
               ...
               if (willDelete) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ url('vendors/store_lanjut_kirim') }}",
                        data: new FormData(form),
                        contentType: false,
                        cache: false,
                        processData:false,
